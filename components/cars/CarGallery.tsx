...
function CarImagePlaceholder() {
  return (
    <div className="w-full aspect-video bg-bg-disabled rounded-xl flex items-center justify-center">
      <svg width="80" height="80" viewBox="0 0 24 24" fill="none" className="text-border-default">
        <path
      ...
      <div className="flex gap-2">
        {[0, 1, 2].map((i) => (
          <button
            ...
            className={`w-16 h-12 rounded-lg border-2 transition-colors flex items-center justify-center bg-bg-disabled ${
              activeImg === i ? 'border-brand' : 'border-transparent hover:border-border-default'
            }`}
          >

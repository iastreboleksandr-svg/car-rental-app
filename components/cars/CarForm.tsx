  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-4 px-4 py-6">
      ...
      <form onSubmit={submit} className="flex flex-col gap-4" noValidate>
        {/* Section 6 — Photos (first for visual prominence) */}
        ...
        <div className="flex flex-col gap-2 sm:flex-row-reverse">
          <Button type="submit" className="sm:flex-1" loading={isSubmitting} disabled={isDeleting}>
            {submitLabel}
          </Button>
          <Button
            type="button"
      ...
      {mode === 'edit' && (
        <div className="mt-2 flex flex-col gap-3 border-t border-border-default pt-5">
          <div>
            <p className="text-sm font-medium text-text-base">{t('dangerTitle')}</p>
            <p className="text-xs text-text-muted">{t('dangerBody')}</p>
          </div>
          <Button
            type="button"

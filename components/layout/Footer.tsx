  ...
  return (
    <footer aria-label="Футер сайта" className="bg-landing-dark-bg text-landing-dark-muted mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        {/* Контакты */}
        <nav aria-label="Контакты и правовая информация">
          <div className="flex flex-col gap-3">
            <p className="text-xs font-semibold text-landing-dark-text uppercase tracking-widest">
              Контакты
            </p>
          ...
          <div className="flex items-center gap-3" role="list" aria-label="Социальные сети">
            {socialLinks.map(({ label, href, svg }) => (
              <a
                ...
                aria-label={label}
                role="listitem"
                className="w-8 h-8 rounded-lg bg-landing-dark-card hover:bg-landing-dark-border flex items-center justify-center text-landing-dark-muted hover:text-landing-dark-text transition-colors"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="14"

        ...
        <div className="bg-bg-card rounded-2xl border border-border-default p-8 sm:p-12">
          ...
          <Section title="2. Какие данные мы собираем">
            ...
            <ul className="space-y-2 text-text-secondary">
              <li className="flex gap-2">
                ...
                <span><strong className="text-text-base">Регистрационные данные:</strong> имя, фамилия, адрес электронной почты, номер телефона, дата рождения.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-brand font-bold mt-0.5">—</span>
                <span><strong className="text-text-base">Данные удостоверения личности:</strong> номер водительского удостоверения, срок его действия.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-brand font-bold mt-0.5">—</span>
                <span><strong className="text-text-base">Платёжные данные:</strong> реквизиты банковской карты (обрабатываются защищёнными платёжными провайдерами).</span>
              </li>
              <li className="flex gap-2">
                <span className="text-brand font-bold mt-0.5">—</span>
                <span><strong className="text-text-base">Данные об использовании:</strong> история бронирований, предпочтения, отзывы.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-brand font-bold mt-0.5">—</span>
                <span><strong className="text-text-base">Технические данные:</strong> IP-адрес, тип браузера, cookies, данные о посещаемых страницах.</span>
              </li>
            </ul>
          </Section>
          ...
          <Section title="4. Правовые основания обработки">
            <p className="text-text-secondary">
              Обработка ваших данных осуществляется на основании:
            </p>
          ...
          <Section title="5. Передача данных третьим лицам">
            <p className="text-text-secondary">
              Мы не продаём ваши данные. Передача данных третьим лицам осуществляется только в 
              следующих случаях:
            </p>
            <ul className="space-y-2 text-text-secondary mt-3">
          ...
          <Section title="7. Хранение данных">
            <p className="text-text-secondary">
              ...
              дополнительно до 3 лет после её удаления — в целях выполнения правовых обязательств. 
              Платёжные документы хранятся 10 лет согласно требованиям немецкого налогового 
              законодательства (§ 147 AO).
            </p>
          </Section>

          <Section title="8. Ваши права">
            <p className="mb-3 text-text-secondary">В соответствии с GDPR вы имеете право:</p>
            <ul className="space-y-2 text-text-secondary">
